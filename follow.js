/*  GitHub Force Follow, version 0.0.1
 *--------------------------------------------------------------------------*/

var GitHubForceFollow = {
  Version: '0.0.1'
};

GitHubForceFollow = new function() {
  this.init = function(username, callback) {
    this.username = username;
    var url = "http://github.com/api/v2/json/repos/show/" + username + "/" + repository + "?callback=GitHubForceFollow.load";
